---
title: "مقدمه"
description: "به صفحه اصلی جدید مستندات خوش آمدید."
---

## تنظیمات

در چند دقیقه، مستندات خود را راه‌اندازی کنید.

<Card title="از اینجا شروع کنید" icon="rocket" horizontal={false} href="/quickstart">
  راهنمای شروع سریع سه مرحله‌ای ما را دنبال کنید.
</Card>
